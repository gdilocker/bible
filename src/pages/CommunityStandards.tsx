            ...
            {[
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    <p>
                      A <strong className="text-black">com.bible</strong> se compromete a criar e manter uma comunidade digital <strong className="text-black">segura, respeitosa, inclusiva e profissional</strong>. Acreditamos que um ambiente positivo beneficia todos os usuários e fortalece nossa rede global.
                    </p>
                    <p>
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    <p>
                      A <strong className="text-black">com.bible</strong> <strong className="text-black">não tolera absolutamente</strong> os seguintes comportamentos:
                    </p>
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <p>
                      A <strong className="text-black">com.bible</strong> disponibiliza ferramentas para que usuários reportem violações desta política:
                    </p>
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside ml-4">
                      <li><strong className="text-black">Botões de denúncia</strong> em conteúdos e perfis;</li>
                      <li><strong className="text-black">Email de suporte</strong> para casos graves: <a href="mailto:legal@com.bible" className="text-slate-700 hover:text-black underline">legal@com.bible</a>;</li>
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside ml-4">
                      <li>Enviar recurso formal para <a href="mailto:legal@com.bible" className="text-slate-700 hover:text-black underline">legal@com.bible</a>;</li>
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <p>
                      A <strong className="text-black">com.bible</strong> se compromete a:
                    </p>
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside ml-4">
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    <p>
                      A <strong className="text-black">com.bible</strong> reserva-se o direito de <strong className="text-black">atualizar esta Política de Padrões da Comunidade</strong> a qualquer momento para refletir:
                    </p>
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside ml-4">
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 mt-4">
                      ...
                      <div className="space-y-3 text-[#6B7280]/70">
                        <p>
                          ...
                          <a href="mailto:support@com.bible" className="text-slate-700 hover:text-black underline">
                            support@com.bible
                          </a>
                        </p>
                        <p>
                          <strong className="text-black">Questões legais e denúncias graves:</strong>{' '}
                          <a href="mailto:legal@com.bible" className="text-slate-700 hover:text-black underline">
                            legal@com.bible
                          </a>
                        </p>
                        <p>
