      ...
      content: (
        <div className="text-[#6B7280]/80 space-y-4">
          ...
          <ol className="space-y-2 text-[#6B7280]/70 list-decimal list-inside">
            <li>Entre em contato através do email <a href="mailto:contact@pix.global" className="text-[#3B82F6] hover:text-[#6B7280]">contact@pix.global</a></li>
    ...
    },
    {
      ...
      content: (
        <div className="text-[#6B7280]/80 space-y-2">
          ...
          <p>
            E-mail: <a href="mailto:contact@pix.global" className="text-[#3B82F6] hover:text-[#6B7280]">contact@pix.global</a>
          </p>
        </div>
      )
    }
