...
const StoreTerms: React.FC = () => {
  const sections = [
    ...
    },
    {
      ...
      content: (
        <div className="text-[#6B7280]/80 space-y-4">
          <p>A pix.global <strong className="text-black">NÃO possui responsabilidade</strong> sobre:</p>
          <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside">
      ...
      content: (
        <div className="text-[#6B7280]/80 space-y-4">
          <p>
            ...
            A pix.global <strong className="text-black">não cobra comissões sobre vendas</strong>.
      ...
      content: (
        <div className="text-[#6B7280]/80 space-y-4">
          ...
          <ul className="space-y-1 text-[#6B7280]/70">
            <li><strong>E-mail:</strong> legal@pix.global</li>
            <li><strong>Formulário:</strong> <a href="/support" className="text-[#3B82F6] hover:text-[#6B7280]">pix.global/support</a></li>
        ...
        >
          ...
          >
            ...
            <div className="relative bg-white backdrop-blur-xl border border-gray-200 rounded-xl p-6">
              ...
              <div className="text-[#6B7280]/80 space-y-4">
                <p>
                  A pix.global não processa pagamentos nem oferece proteção ao comprador.
