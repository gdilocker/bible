    ...
    try {
      if (editingId) {
        ...
        await supabase
          ...
          .eq('fqdn', `${formData.domain_name}.pix.global`);
      }
        ...
        <div className="bg-gradient-to-br from-yellow-50 to-amber-50 border-2 border-yellow-400 rounded-xl p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              />
              <p className="text-xs text-gray-600 mt-1">Sem .pix.global - apenas o nome</p>
            </div>
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-1">
                Nome de Exibição *
              ...
              <tr key={brand.id} className="hover:bg-slate-50">
                {editingId === brand.id ? (
                  ...
                  <>
                    ...
                    <td className="py-4 px-6">
                      <code className="text-sm bg-slate-100 px-2 py-1 rounded">{brand.domain_name}.pix.global</code>
                    </td>
