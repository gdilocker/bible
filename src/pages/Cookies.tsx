              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#6B7280]/80 leading-relaxed">
                    O <strong>.com.bible</strong>, operado pela <strong>Global Digital Identity LTD</strong>, utiliza cookies e tecnologias similares para garantir o funcionamento seguro da plataforma e aprimorar nossos serviços.
                  </p>
                </div>
              </div>
            </div>
            ...
            {[
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <p>
                      O <strong className="text-black">.com.bible</strong>, operado pela <strong className="text-black">Global Digital Identity LTD</strong>, utiliza cookies e tecnologias similares (como <em>local storage</em> e <em>pixels</em>) para garantir o funcionamento seguro da plataforma e aprimorar nossos serviços.
                    </p>
                  </div>
                )
              },
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <p className="font-semibold text-black mt-4">
                      O .com.bible não utiliza cookies de marketing nem rastreamento publicitário.
                    </p>
                  </div>
                )
              },
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <p>
                      O <strong className="text-black">.com.bible</strong> disponibiliza um <strong className="text-black">Centro de Preferências de Cookies</strong>, acessível pelo banner de consentimento no rodapé do site, onde você pode:
                    </p>
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside">
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <p>
                      O .com.bible obtém <strong className="text-black">consentimento explícito</strong> para qualquer cookie não essencial, conforme exigido pelas legislações britânica e europeia de proteção de dados.
                    </p>
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-2">
                    ...
                    <p className="mt-3">
                      E-mail: <a href="mailto:privacy@com.bible" className="text-[#3B82F6] hover:text-[#6B7280] font-semibold">privacy@com.bible</a>
                    </p>
                    <p>
                      Suporte: <a href="mailto:support@com.bible" className="text-[#3B82F6] hover:text-[#6B7280] font-semibold">support@com.bible</a>
                    </p>
