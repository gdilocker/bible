                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside">
                      <li>Registro, gerenciamento e renovação de domínios .com.bible</li>
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside">
                      <li><strong className="text-black">Email:</strong> <a href="mailto:contact@com.bible" className="text-[#3B82F6] hover:underline">contact@com.bible</a></li>
                      ...
                      <div className="relative bg-white backdrop-blur-xl border border-gray-200 rounded-xl p-6">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-[#6B7280]/80 mb-2">
                              <strong className="text-black">Encarregado de Proteção de Dados (DPO):</strong> dpo@com.bible
                            </p>
                            <p className="text-[#6B7280]/80 mb-2">
                              <strong className="text-black">Email geral:</strong> <a href="mailto:contact@com.bible" className="text-[#3B82F6] hover:underline">contact@com.bible</a>
                            </p>
