              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside">
                      <li>Entre em contato com o suporte em <a href="mailto:contact@pix.global" className="text-[#3B82F6] hover:underline">contact@pix.global</a></li>
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <p>
                      Você tem o direito de contestar qualquer suspensão ou encerramento através do email <a href="mailto:contact@pix.global" className="text-[#3B82F6] hover:underline">contact@pix.global</a>, fornecendo:
                    </p>
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside">
                      ...
                      <div className="relative bg-white backdrop-blur-xl border border-gray-200 rounded-xl p-6">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-[#6B7280]/80 mb-2">
                              <strong className="text-black">Email:</strong> <a href="mailto:contact@pix.global" className="text-[#3B82F6] hover:underline">contact@pix.global</a>
                            </p>
                            <p className="text-[#6B7280]/80 mb-2">
