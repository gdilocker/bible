    ...
    <PanelLayout>
      <div className="max-w-7xl mx-auto">
        <div className="px-4 sm:px-6 lg:px-8">
          <PageHeader
            title={domainName ? `Gerenciar Página - ${domainName.replace('.pix.global', '')}` : "Gerenciar Página"}
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center gap-2 px-4 py-3 bg-slate-50 border border-slate-300 rounded-lg overflow-x-auto">
                  <span className="text-slate-500 text-sm whitespace-nowrap">pix.global/</span>
