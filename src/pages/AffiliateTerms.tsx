  ...
  const sections = [
      ...
      content: (
        <div className="text-[#6B7280]/80 space-y-4">
          <div>
            ...
            <p>Participante aceito no Programa de Afiliados .pix.global.</p>
          </div>
          ...
          <div>
            ...
            <p>Os serviços e sites digitais operados sob o domínio .pix.global, gerenciados pela empresa Global Digital Identity LTD.</p>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="text-[#6B7280]/80 space-y-4">
          <p>
            A presente política foi registrada publicamente no órgão britânico <strong className="text-black">Companies House</strong> sob o título <strong className="text-black">"Affiliate Program Governance Policy – .pix.global"</strong>, como documento oficial de governança vinculado à empresa <strong className="text-black">Global Digital Identity LTD</strong>.
          </p>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="text-[#6B7280]/80 space-y-4">
          <p>
            O Programa de Afiliados .pix.global é uma iniciativa comercial legítima, criada para permitir que afiliados promovam os serviços digitais da plataforma e recebam comissões com base em vendas reais e confirmadas, sempre em conformidade com as leis aplicáveis e os princípios de transparência, responsabilidade e legalidade.
          </p>
        </div>
      )
    },
      ...
      content: (
        <div className="text-[#6B7280]/80 space-y-4">
          <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside ml-4">
            ...
            <li><strong className="text-black">4.2</strong> Usuários com domínio ativo registrado na plataforma .pix.global;</li>
    ...
    },
    {
      ...
      content: (
        <div className="text-[#6B7280]/80 space-y-4">
          <p>
            O Programa de Afiliados .pix.global é <strong className="text-black">transparente, legítimo e baseado em valor real</strong>.
          </p>
          <p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#6B7280]/80 leading-relaxed">
                    Este documento estabelece as regras oficiais do Programa de Afiliados pix.global. Ao participar, você concorda integralmente com todos os termos aqui descritos.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative bg-gradient-to-r from-slate-50 to-blue-50 backdrop-blur-xl border-2 border-blue-300 rounded-xl p-6 shadow-lg mt-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#6B7280]/90 leading-relaxed mb-3">
                    Os <strong className="text-black">Termos de Afiliados do .pix.global</strong> são documentos oficiais registrados na <strong className="text-black">Companies House</strong>, órgão do governo do Reino Unido responsável pelo registro e supervisão de empresas.
                  </p>
                  <p className="text-[#6B7280]/90 leading-relaxed mb-3">
