        ...
        <div className="text-[#6B7280] space-y-6">
          <div className="space-y-3">
            ...
            <p className="leading-relaxed pl-9">
              Adquira sua licença exclusiva .pix.global, crie sua conta e ative um dos planos pagos disponíveis.
            </p>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-3">
                <p className="leading-relaxed text-amber-900">
                  O recebimento de comissões está condicionado à validação interna, manutenção da conta ativa e confirmação da assinatura pelo cliente. <strong>É OBRIGATÓRIO ter licença .pix.global ativa E plano de assinatura pago para participar.</strong>
                </p>
    ...
    >
      ...
      <div className="mt-8 bg-gradient-to-br from-black to-[#1a1b2e] rounded-2xl p-8 text-center">
        ...
        <p className="text-white/80 mb-6 max-w-2xl mx-auto">
          Adquira sua licença .pix.global, ative um plano pago (Prime ou Elite) e comece a receber comissões mensais recorrentes hoje mesmo.
        </p>
