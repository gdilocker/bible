      ...
      content: (
        <div className="text-[#6B7280] space-y-4">
          ...
          <p className="leading-relaxed">
            As comissões são vinculadas a transações efetivamente pagas e podem ser solicitadas após 30 dias da confirmação do pagamento. <strong className="text-black">Plano Prime: 25% | Plano Elite: 50%</strong>
          </p>
          <p className="leading-relaxed">
            ...
            <div>
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3 mb-3">
                <p className="text-emerald-900 text-sm leading-relaxed">
                  <strong>Planos (mensal) e domínios (anual)</strong> geram comissão recorrente — <strong>25% (Prime)</strong> ou <strong>50% (Elite)</strong> — sempre sobre o valor líquido.
                </p>
              </div>
