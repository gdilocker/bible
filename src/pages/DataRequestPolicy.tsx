                  ...
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 my-4">
                      ...
                      <ul className="space-y-1 text-[#6B7280]/80 list-disc list-inside">
                        <li><strong>Email:</strong> <a href="mailto:data-request@pix.global" className="text-[#3B82F6] hover:underline">data-request@pix.global</a></li>
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside">
                      <li><strong className="text-black">Email prioritário:</strong> <a href="mailto:urgent@pix.global" className="text-[#3B82F6] hover:underline">urgent@pix.global</a></li>
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <ol className="space-y-2 text-[#6B7280]/70 list-decimal list-inside">
                      <li>Entre em contato com nosso DPO (Data Protection Officer) em <a href="mailto:dpo@pix.global" className="text-[#3B82F6] hover:underline">dpo@pix.global</a></li>
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <ul className="space-y-2 text-[#6B7280]/80">
                              <li><strong className="text-black">Solicitações de dados:</strong> <a href="mailto:data-request@pix.global" className="text-[#3B82F6] hover:underline">data-request@pix.global</a></li>
                              <li><strong className="text-black">Data Protection Officer:</strong> <a href="mailto:dpo@pix.global" className="text-[#3B82F6] hover:underline">dpo@pix.global</a></li>
                              <li><strong className="text-black">Suporte geral:</strong> <a href="mailto:contact@pix.global" className="text-[#3B82F6] hover:underline">contact@pix.global</a></li>
