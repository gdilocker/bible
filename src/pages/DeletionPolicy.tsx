                  ...
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 my-4">
                      ...
                      <ul className="space-y-1 text-[#6B7280]/80 list-disc list-inside">
                        <li><strong>Email:</strong> <a href="mailto:deletion@pix.global" className="text-[#3B82F6] hover:underline">deletion@pix.global</a></li>
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside">
                      <li>Perfis públicos (ex: seunome.pix.global) são <strong className="text-[#EF4444]">permanentemente removidos</strong></li>
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <ul className="space-y-2 text-[#6B7280]/80">
                              <li><strong className="text-black">Email para exclusão:</strong> <a href="mailto:deletion@pix.global" className="text-[#3B82F6] hover:underline">deletion@pix.global</a></li>
