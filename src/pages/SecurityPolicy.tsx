    ...
    },
    {
      ...
      content: (
        <div className="text-[#6B7280]/80 space-y-4">
          ...
          <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside">
            <li>Reporte imediatamente para <a href="mailto:contact@pix.global" className="text-[#3B82F6] hover:text-[#6B7280]">contact@pix.global</a></li>
    ...
    },
    {
      ...
      content: (
        <div className="text-[#6B7280]/80 space-y-2">
          ...
          <p>
            E-mail de segurança: <a href="mailto:contact@pix.global" className="text-[#3B82F6] hover:text-[#6B7280]">contact@pix.global</a>
          </p>
