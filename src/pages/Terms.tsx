            ...
            {[
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    <p>
                      Bem-vindo ao <strong className="text-black">.pix.global</strong>, um serviço operado pela <strong className="text-black">Global Digital Identity LTD</strong>, empresa registrada na Inglaterra e País de Gales sob o número <strong className="text-black">Company No. 16339013</strong>, com sede em <strong className="text-black">71–75 Shelton Street, Covent Garden, Londres, WC2H 9JQ, Reino Unido</strong> (".pix.global", "Plataforma", "Serviço", "nós", "nosso").
                    </p>
                    <p>
                      <strong className="text-black">Contato oficial:</strong> <a href="mailto:support@pix.global" className="text-[#3B82F6] hover:text-[#6B7280]">support@pix.global</a>
                    </p>
                    <p>
                      Ao acessar, criar uma conta ou utilizar qualquer serviço do .pix.global, você ("Usuário", "Cliente") declara ter lido, compreendido e aceitado integralmente estes <strong className="text-black">Termos de Uso</strong> e a <strong className="text-black">Política de Privacidade</strong> correspondente.
                    </p>
                    <p>
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    <p>O <strong className="text-black">.pix.global</strong> é uma plataforma digital que oferece:</p>
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside">
                      <li>Registro, renovação e administração de domínios com a extensão <strong className="text-black">.pix.global</strong>;</li>
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <p>Para utilizar o .pix.global, o usuário deve:</p>
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside">
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <p>
                      O acesso à plataforma .pix.global requer uma <strong className="text-black">assinatura mensal ativa</strong>.
                      Existem dois planos principais:
                    </p>
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside ml-4">
                      <li><strong className="text-black">Prime ($50/mês):</strong> Inclui 1 domínio .pix.global, sistema completo de links personalizados, analytics, QR codes e participação no programa de afiliados com comissão de 25% sobre vendas de planos de assinatura.</li>
                    ...
                    <p>
                      <strong className="text-black">IMPORTANTE:</strong> Todos os domínios .pix.global são propriedade exclusiva da
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <p>
                      O uso do .pix.global é feito <strong className="text-black">sob inteira responsabilidade do usuário</strong>.
                    </p>
                  </div>
                )
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    <p>
                      O .pix.global cumpre integralmente o <strong className="text-black">UK Data Protection Act 2018</strong> e o <strong className="text-black">General Data Protection Regulation (GDPR)</strong> da União Europeia.
                    </p>
                    ...
                    <p>
                      Solicitações devem ser enviadas a <a href="mailto:support@pix.global" className="text-[#3B82F6] hover:text-[#6B7280]">support@pix.global</a>.
                    </p>
                    <p>
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside">
                      ...
                      <li>utilizar as marcas ".pix.global" ou "Global Digital Identity LTD" sem autorização;</li>
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-4">
                    ...
                    <ul className="space-y-2 text-[#6B7280]/70 list-disc list-inside">
                      <li><strong className="text-black">E-mail:</strong> <a href="mailto:support@pix.global" className="text-[#3B82F6] hover:text-[#6B7280]">support@pix.global</a></li>
                      <li><strong className="text-black">Formulário:</strong> disponível em pix.global/contato</li>
                    </ul>
              ...
              },
              {
                ...
                content: (
                  <div className="text-[#6B7280]/80 space-y-2">
                    ...
                    <p>
                      E-mail: <a href="mailto:support@pix.global" className="text-[#3B82F6] hover:text-[#6B7280]">support@pix.global</a>
                    </p>
                  </div>
                )
              }
