  ...
  const faqSections: FAQSection[] = [
    {
      ...
      items: [
        {
          question: 'O que é o pix.global?',
          answer: (
            <div className="space-y-2">
              <p>O <strong>pix.global</strong> é uma plataforma de identidade digital que oferece domínios exclusivos com a extensão <strong>.pix.global</strong>, desenvolvida para profissionais e marcas que desejam destacar-se online com um nome de domínio sofisticado e premium.</p>
        ...
        {
          question: 'O pix.global é uma empresa independente?',
          answer: 'Sim. O pix.global é operado pela Global Digital Identity LTD, empresa independente registrada no Reino Unido, que atua de forma autônoma em sua operação comercial e tecnológica. A plataforma mantém controle total sobre a experiência do usuário, suporte e gestão de contas.'
        },
        {
      ...
      items: [
        {
          ...
          answer: (
            <div className="space-y-2">
              <p>Ao adquirir um domínio .pix.global, você recebe uma <strong>licença exclusiva de uso</strong>. Isso significa que você tem direitos totais de personalização, configuração e uso do domínio, mas a titularidade permanece com Global Digital Identity LTD.</p>
        ...
        },
        {
          ...
          answer: 'Sim, transferências de licença são permitidas mediante aprovação. Entre em contato com support@pix.global para iniciar o processo.'
        },
        {
        ...
        },
        {
          ...
          answer: 'O modelo de licenciamento nos permite manter controle central sobre a rede .pix.global, garantir qualidade do ecossistema, prevenir abuso e oferecer melhor suporte. Além disso, facilita resolução de disputas e proteção de marca.'
        }
      ]
    },
    {
      ...
      items: [
        {
          question: 'O que é um domínio .pix.global?',
          answer: 'É uma extensão de domínio premium e exclusiva, projetada para profissionais, marcas e indivíduos que buscam uma identidade digital sofisticada. Com uma licença exclusiva .pix.global (exemplo: seunome.pix.global), você terá uma URL personalizada que reflete sucesso e exclusividade.'
        },
        {
      ...
      items: [
        {
          ...
          answer: 'É uma página web vinculada ao seu domínio .pix.global onde você pode centralizar todos os seus links importantes: redes sociais, portfólio, contatos e muito mais. Funciona como um cartão de visitas digital profissional.'
        },
        {
        ...
        },
        {
          ...
          answer: 'Sim. Seu domínio .pix.global vem com um perfil social personalizado integrado na plataforma, mas você tem liberdade total para configurar os registros DNS e redirecionar para qualquer site ou serviço de hospedagem externo. Dessa forma, você mantém controle completo sobre como utiliza seu domínio.'
        },
        {
            ...
            <div className="space-y-3">
              ...
              <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded-r-lg">
                ...
                <ul className="list-disc list-inside space-y-1 text-red-800 text-sm">
                  ...
                  <li><strong>Domínio .pix.global:</strong> Entra em estado protegido</li>
        ...
        },
        {
          ...
          answer: (
            <div className="space-y-3">
              ...
              <p className="text-sm mt-3"><strong>Por que essas regras?</strong> Elas garantem estabilidade nas assinaturas, protegem contra abusos e reforçam a exclusividade da plataforma .pix.global.</p>
            </div>
          )
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        {
          question: 'O pix.global utiliza cookies?',
        ...
        },
        {
          ...
          answer: 'Entre em contato imediatamente pelo e-mail contact@pix.global. Casos comprovados de uso fraudulento resultam em suspensão imediata da conta e notificação às autoridades competentes.'
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          answer: (
            <div className="space-y-3">
              <p>O Programa de Afiliados permite que você ganhe comissões recorrentes promovendo <strong className="text-black">exclusivamente planos de assinatura</strong> da plataforma .pix.global.</p>
        ...
        },
        {
          ...
          answer: (
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li><strong>Licença .pix.global ativa</strong></li>
    ...
    },
    {
      ...
      items: [
        ...
        {
          question: 'O pix.global é responsável pelo conteúdo publicado pelos usuários?',
        ...
        {
          question: 'Qual é a jurisdição legal do pix.global?',
      ...
      items: [
        {
          ...
          answer: (
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li><strong>E-mail:</strong> contact@pix.global</li>
        ...
        {
          question: 'O pix.global oferece suporte em outros idiomas?',
        ...
        },
        {
          ...
          answer: 'Envie um e-mail para abuse@pix.global com o máximo de informações possíveis (capturas de tela, URLs, data, domínio envolvido). As denúncias são analisadas pela equipe de conformidade dentro de 48h.'
        },
        {
          question: 'Posso usar o pix.global em qualquer país?',
        ...
        {
          question: 'O que diferencia o pix.global de outros serviços?',
          answer: (
            <ul className="list-disc list-inside space-y-1">
              <li>Extensão de domínio exclusiva e premium (.pix.global).</li>
        ...
        >
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-[#6B7280] leading-relaxed">
              Encontre respostas para as dúvidas mais comuns sobre domínios .pix.global, perfis sociais, pagamentos, segurança e muito mais
            </p>
          </div>
        </motion.section>
