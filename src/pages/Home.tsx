...
const Home = () => {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    for (let attempt = 0; attempt <= maxRetries; attempt++) {
      try {
        const domainToCheck = domain.endsWith('.com.bible') ? domain : `${domain}.com.bible`;
  ...
  const handleProvision = async () => {
    ...
    const domainToRegister = domain.endsWith('.com.bible') ? domain : `${domain}.com.bible`;
          ...
          >
            <div className="text-center mb-6 sm:mb-8" >
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-4 sm:mb-6 leading-relaxed font-light px-4">
                Mais do que um domínio, <strong className="text-amber-400">.com.bible</strong> é a chave para um mundo de oportunidades e reconhecimento global.
              </p>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-2 sm:mb-3 leading-tight tracking-tight font-bold px-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-2 sm:mb-3 leading-relaxed font-light px-4">
                Com um domínio único, sua presença online é exclusivamente sua. Haverá apenas uma <strong className="text-amber-400">olivia.com.bible</strong>, uma <strong className="text-amber-400">james.com.bible</strong>, uma <strong className="text-amber-400">isabella.com.bible</strong>.
              </p>
          ...
          >
            <div className="text-center mb-6 sm:mb-10 lg:mb-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-2 sm:mb-3 leading-tight tracking-tight font-bold text-white px-4">
                Sua licença .com.bible em três etapas
              </h2>
              ...
              {[
                {
                  ...
                  description: 'Encontre o nome perfeito dentro do universo .com.bible e garanta sua licença exclusiva de uso.'
                },
                {
                  step: '02',
                  icon: Lock,
                  title: 'Adquira sua licença',
                  description: 'Finalize sua contratação com segurança. Sua licença exclusiva .com.bible será ativada instantaneamente e vinculada ao seu perfil.'
                },
                {
                  step: '03',
                  icon: Link2,
                  title: 'Tudo em um só lugar',
                  description: 'Sua licença .com.bible inclui uma página moderna e personalizável, onde você conecta redes, negócios e oportunidades, tudo em um\u00A0só\u00A0link.'
                }
              ].map((step, index) => (
                <motion.div
                  key={index}
        ...
        <section className="relative bg-gradient-to-b from-zinc-950 to-black py-6 sm:py-10 lg:py-12">
          ...
          >
            <div className="text-center mb-6 sm:mb-10 lg:mb-12">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-0 leading-relaxed font-light px-4">
                O domínio .com.bible representa uma nova forma de presença digital feita para quem quer unir valor, propósito e exclusividade.
                Mais do que um endereço na web, ele é uma declaração de identidade: cada nome em .com.bible reflete quem você é e o que deseja transmitir ao mundo.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: 'Cada licença .com.bible é protegida com tecnologia avançada e protocolos de segurança global, garantindo total proteção para sua identidade digital.'
                },
                {
                  icon: Zap,
                  title: 'Ativação instantânea',
                  description: 'Tudo é preparado automaticamente. Em poucos instantes, sua licença .com.bible estará ativa e conectada à sua página personalizada.'
                },
                {
                  icon: Globe,
                  title: 'Identidade profissional',
                  description: 'Uma licença .com.bible transforma sua presença online em algo memorável, distinto e visualmente sofisticado.'
                }
              ].map((feature, index) => (
                <motion.div
                  key={index}
              ...
              <div className="relative bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 rounded-2xl sm:rounded-3xl p-8 sm:p-12 md:p-16 text-center shadow-2xl border border-white/10 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <p className="text-sm sm:text-base md:text-lg text-amber-400/90 mb-4 sm:mb-6 max-w-2xl mx-auto font-medium px-4 break-all">
                    https://seunome.com.bible / https://com.bible/seunome
                  </p>
                  <button
