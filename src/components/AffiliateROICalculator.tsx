    ...
    <div className="w-full space-y-8">
      ...
      >
        ...
        <div className="mt-6 bg-gradient-to-r from-blue-50 to-slate-50 border-2 border-blue-200 rounded-lg p-4">
          ...
          <p className="text-xs text-gray-700 leading-relaxed text-center">
            Os Termos de Afiliados do .com.bible são documentos oficiais registrados na <strong className="text-black">Companies House</strong> (Reino Unido), garantindo transparência jurídica e autenticidade internacional.
          </p>
