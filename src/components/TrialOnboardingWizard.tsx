...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    description: 'Configure sua página pessoal com foto, bio e links. É o coração da sua identidade digital .pix.global',
            ...
            {currentStep === 0 && (
              <div className="bg-emerald-50 rounded-xl p-6 mb-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start gap-2 text-emerald-800">
                    <Check className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                    <span>Domínio .pix.global exclusivo e personalizável</span>
                  </li>
                  <li className="flex items-start gap-2 text-emerald-800">
                    <Check className="w-5 h-5 text-emerald-600 flex-shrink-0 mt-0.5" />
