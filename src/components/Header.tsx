...
export default function Header() {
  ...
  return (
    <motion.header
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className="fixed w-full top-0 z-50 bg-gradient-to-r from-slate-900 to-slate-800 border-b border-slate-700 shadow-2xl"
    >
        ...
        <div className="flex justify-between items-center h-16 gap-2">
          ...
          <div className="hidden md:flex items-center gap-1">
            {!user ? (
              <>
                ...
                <Link
                  to="/signup"
                  className="px-6 py-2 bg-slate-700 hover:bg-slate-600 text-white font-semibold rounded-lg transition-colors shadow-lg"
                >
                  Começar
                </Link>
              </>
              ...
              <>
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 hover:bg-slate-700 rounded-lg transition-colors border border-slate-600"
                  >
          ...
          <div className="relative md:hidden ml-auto">
            <button
              ...
              className="p-1.5 rounded text-white hover:bg-gray-800 transition-colors flex-shrink-0"
            >
