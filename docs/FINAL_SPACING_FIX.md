...
- [x] Home - Título afastado do header ✅
- [x] Register - Título afastado do header ✅
- [x] Pricing - Mantém padrão default ✅
- [x] GlobalSystem - Mantém padrão large fixo ✅
- [x] RichClub/Sobre - Título afastado do header ✅
- [x] Build sem erros ✅
